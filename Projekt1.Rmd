...
$$
Thus we get a exponential samples, by sampling from the uniform distribution, and use the inversion method. Under it a function that generates a vector of $n$ samples from an exponentially distributed random variable with rate $\lambda$.
